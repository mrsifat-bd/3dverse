...
export default function ProductCard({ product }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-2xl border border-line bg-paper transition-all duration-200 hover:-translate-y-0.5 hover:border-clay/40"
    >
      <div className="relative aspect-square overflow-hidden bg-line/40">
        ...
        {!product.in_stock && (
          <Badge variant="solid" className="absolute left-3 top-3">Made to order</Badge>
        )}
      </div>
